...
class TestValidateConfigSchema:
    ...
    def test_validate_config_schema_allowed_values(self):
        ...
        schema = {
            "mode": {"type": str, "required": True, "allowed_values": ["development", "production", "test"]},
            "debug": {"type": bool, "required": False}
        }
...
class TestMergeConfigFiles:
    ...
    def test_merge_config_files_ini(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".ini", delete=False) as temp1, \
             tempfile.NamedTemporaryFile(suffix=".ini", delete=False) as temp2:
    ...
    def test_merge_config_files_mixed_formats(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".ini", delete=False) as temp1, \
             tempfile.NamedTemporaryFile(suffix=".yaml", delete=False) as temp2:
            temp1_path = temp1.name
            temp2_path = temp2.name
